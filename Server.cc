...
class Server: public cSimpleModule{
    ...
    cMessage *failureMsg; //message used to shut down a client/server
...
void Server::initialize(){
    ...
    if (deadProbability < realProbability) {
        ...
        EV << "Here is server[" + std::to_string(this->getIndex()) + "]: I will be dead in " + std::to_string(randomDelay) + " seconds...\n";
