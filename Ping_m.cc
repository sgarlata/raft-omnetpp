...
Ping::Ping(const char *name, short kind) : ::omnetpp::cPacket(name,kind)
{
    this->clientIndex = 0;
    this->execIndex = 0;
    this->identifier = 0;
...
Ping::Ping(const Ping& other) : ::omnetpp::cPacket(other)
{
    copy(other);
}
...
void Ping::copy(const Ping& other)
{
    ...
    this->execIndex = other.execIndex;
...
void Ping::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->clientIndex);
    doParsimPacking(b,this->execIndex);
...
void Ping::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->clientIndex);
    doParsimUnpacking(b,this->execIndex);
    doParsimUnpacking(b,this->identifier);
}

int Ping::getClientIndex() const
{
    return this->clientIndex;
}

void Ping::setClientIndex(int clientIndex)
{
    this->clientIndex = clientIndex;
}

int Ping::getExecIndex() const
{
    return this->execIndex;
}

void Ping::setExecIndex(int execIndex)
{
    this->execIndex = execIndex;
}

int Ping::getIdentifier() const
{
    return this->identifier;
}

void Ping::setIdentifier(int identifier)
{
...
PingDescriptor::PingDescriptor() : omnetpp::cClassDescriptor("Ping", "omnetpp::cPacket")
{
...
int PingDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='c' && strcmp(fieldName, "clientIndex")==0) return base+0;
    if (fieldName[0]=='e' && strcmp(fieldName, "execIndex")==0) return base+1;
...
std::string PingDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    Ping *pp = (Ping *)object; (void)pp;
    switch (field) {
        case 0: return long2string(pp->getClientIndex());
        case 1: return long2string(pp->getExecIndex());
...
bool PingDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    Ping *pp = (Ping *)object; (void)pp;
    switch (field) {
        case 0: pp->setClientIndex(string2long(value)); return true;
        case 1: pp->setExecIndex(string2long(value)); return true;
